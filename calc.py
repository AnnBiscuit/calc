...
def interactive_mode(angle_unit='radian'):
    print(f"Calculator (angles in {'degrees' if angle_unit == 'degree' else 'radians'})")
    print("Print 'exit' or 'quit' to exit")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='----------Mathematical expression calculator----------')
    parser.add_argument('expression', nargs='?', help='expression to calculate')
    parser.add_argument('-i', '--interactive', action='store_true', help='interactive mode')
    parser.add_argument('--degree', action='store_true', help='use degree instead of radian')
